...
const copy = {
  en: {
    ...
    paymentNote: "Secure payment is handled by Stripe. PayPal appears in Checkout when it is activated for the Ma'z Êst Stripe account.",
  ...
  tr: {
    ...
    paymentNote: "Güvenli ödeme Stripe üzerinden yapılır. PayPal, Ma'z Êst Stripe hesabında etkinleştirildiğinde ödeme ekranında görünür.",
    paymentMethodsLabel: "Kabul edilen ödeme yöntemleri",
    cardsLabel: "Kartlar",
  ...
  za: {
    ...
    paymentNote: "Pardayışê ewle bi Stripe bena. PayPal eger hesabê Stripe yê Ma'z Êst de aktif bibo, Checkout de aseno.",
    paymentMethodsLabel: "Rayîrê pardayışî",
    cardsLabel: "Kartî",
  ...
  ku: {
    ...
    paymentNote: "Dayîna ewle bi Stripe tê kirin. PayPal dema ku di hesabê Stripe yê Ma'z Êst de were çalak kirin di Checkout de xuya dibe.",
    paymentMethodsLabel: "Rêbazên dayînê",
    cardsLabel: "Kart",
...
copy.fr = {
  ...
  paymentNote: "Paiement sécurisé via Stripe. PayPal apparaît dans Checkout dès qu'il est activé sur le compte Stripe Ma'z Êst.",
...
copy.de = {
  ...
  paymentNote: "Sichere Zahlung über Stripe. PayPal erscheint im Checkout, sobald es im Stripe-Konto von Ma'z Êst aktiviert ist.",
